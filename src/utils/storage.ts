...
import { Classroom, Student, AttendanceRecord, SchoolSettings, UserSession, ParentAccount, WeeklyMenu, AbsenceReport, TeacherAccount, HealthRecord, DailyAssessment, TeacherNotification, SchoolEvent, ClassActivity, ParentNotification, MedicationRequest, NoonSupervisionShift } from '../types';
